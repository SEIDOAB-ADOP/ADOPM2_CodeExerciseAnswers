...
namespace _05_Wines_Interfaces
{
    public class WineCellar
    {
        ...
        public IWine this[int idx] => new WineAsClass(Wines[idx]);
        ...
        public List<IWine> DeepCopyofWines => Wines.Select(w => new WineAsClass(w)).ToList<IWine>();
        ...
        public List<IWine> DeepCopyofWines2
        {
            get
            {
                ...
                {
                    _copy.Add(new WineAsClass(item));
                }
                return _copy;
            }
        }
